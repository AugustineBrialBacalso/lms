...
<body>
    ...
    <div id="uppernav" class="uppernav">
        ...
        <div class="listbook-container">
            <h4 class="list-name">List of Books</h4>
            ...
            <table class="tbl-container">
                ...
                <thead class="list-head">
                    <tr>
                        ...
                        <th colspan="3" class="list-title">Action</th>
                    </tr>
                </thead>
                ...
                <tbody class="list-tbody">
                    ...
                    $query = "SELECT id, title, author, quantity FROM books"; // Removed 'status'
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td><a href='view-list-books.php?id=" . $row['id'] . "' title='View'><button class='view-btn'><i class='fa-solid fa-eye'></i></button></div></a></td>";
                            echo "<td><a href='update-list-books.php?id=" . $row['id'] . "' title='Update'><button class='update-btn'><i class='fa-solid fa-pencil'></i></button></a></td>";
                            echo "<td><a class='delete' href='delete-book.php?id=" . $row['id'] . "' title='Delete'><button class='delete-btn'><i class='fa-solid fa-trash-can'></i></button></a></td>";
                            echo "</tr>";
                        }
                    } else {
